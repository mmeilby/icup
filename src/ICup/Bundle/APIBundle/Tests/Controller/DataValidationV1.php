...
class DataValidationV1 extends WebTestCase
{
    ...
    public function testTournamentGet()
    {
        ...
        $this->assertAttributeEquals($this->tournament->getHost()->getAlias(), "alias", $tournament->host);
        $this->assertAttributeEquals($this->tournament->getHost()->getDomain(), "domain", $tournament->host);
    }
